...
*/
func (a *DefinedEntityApiService) CreateDefinedEntity(ctx context.Context, entity DefinedEntity, id string) (*http.Response, error) {
	var (
...
*/
func (a *DefinedEntityApiService) DeleteDefinedEntity(ctx context.Context, id string) (*http.Response, error) {
	var (
