...
func (a *EdgeGatewayLoadBalancerPoolsApiService) CreateLoadBalancerPool(ctx context.Context, loadBalancerPool EdgeLoadBalancerPool) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/loadBalancer/pools"
	...
	// body params
	localVarPostBody = &loadBalancerPool
	if ctx != nil {
...
/*
EdgeGatewayLoadBalancerPoolsApiService Retrieves all Load Balancer Pool Summaries for a given Edge Gateway.
 ...
 * @param gatewayId
 * @param optional nil or *EdgeGatewayLoadBalancerPoolsApiGetPoolSummariesForGatewayOpts - Optional Parameters:
...
@return EdgeLoadBalancerPoolSummaries
*/
...
func (a *EdgeGatewayLoadBalancerPoolsApiService) GetPoolSummariesForGateway(ctx context.Context, page int32, pageSize int32, gatewayId string, localVarOptionals *EdgeGatewayLoadBalancerPoolsApiGetPoolSummariesForGatewayOpts) (EdgeLoadBalancerPoolSummaries, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EdgeLoadBalancerPoolSummaries
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/loadBalancer/poolSummaries"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v EdgeLoadBalancerPoolSummaries
