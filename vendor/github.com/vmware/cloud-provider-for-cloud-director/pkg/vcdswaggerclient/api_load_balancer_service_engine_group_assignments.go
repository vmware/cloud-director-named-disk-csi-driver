...
/*
LoadBalancerServiceEngineGroupAssignmentsApiService Create a new Load Balancer Service Engine Group Assignment.
...
*/
func (a *LoadBalancerServiceEngineGroupAssignmentsApiService) CreateServiceEngineGroupAssignment(ctx context.Context, assignment LoadBalancerServiceEngineGroupAssignment) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/loadBalancer/serviceEngineGroups/assignments"
...
/*
LoadBalancerServiceEngineGroupAssignmentsApiService Get the assignments for a Load Balancer Service Engine Group.
 ...
 * @param optional nil or *LoadBalancerServiceEngineGroupAssignmentsApiGetServiceEngineGroupAssignmentsOpts - Optional Parameters:
...
@return LoadBalancerServiceEngineGroupAssignments
*/
