...
/*
EdgeGatewayApiService Deletes a specific Edge Gateway
Deletes a specific Edge Gateway. Only NSX-T Edge Gateways can be deleted with this endpoint.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param gatewayId
 * @param optional nil or *EdgeGatewayApiDeleteEdgeGatewayOpts - Optional Parameters:
...
func (a *EdgeGatewayApiService) DeleteEdgeGateway(ctx context.Context, gatewayId string, localVarOptionals *EdgeGatewayApiDeleteEdgeGatewayOpts) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}"
...
/*
EdgeGatewayApiService Retrieve the list of IP addresses which are being used by the edge gateway.
 ...
 * @param gatewayId
 * @param optional nil or *EdgeGatewayApiGetUsedIpAddressesOpts - Optional Parameters:
...
func (a *EdgeGatewayApiService) GetUsedIpAddresses(ctx context.Context, page int32, pageSize int32, gatewayId string, localVarOptionals *EdgeGatewayApiGetUsedIpAddressesOpts) (GatewayUsedIpAddresses, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/usedIpAddresses"
	localVarPath = strings.Replace(localVarPath, "{"+"gatewayId"+"}", fmt.Sprintf("%v", gatewayId), -1)
...
/*
EdgeGatewayApiService Updates a specific Edge Gateway
