...
func (a *EdgeGatewayNatRulesApiService) CreateNatRule(ctx context.Context, edgeNatRule EdgeNatRule, gatewayId string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/nat/rules"
...
/*
EdgeGatewayNatRulesApiService Retrieves all NAT Rules on the edge gateway.
 ...
 * @param gatewayId
 * @param optional nil or *EdgeGatewayNatRulesApiGetNatRulesOpts - Optional Parameters:
