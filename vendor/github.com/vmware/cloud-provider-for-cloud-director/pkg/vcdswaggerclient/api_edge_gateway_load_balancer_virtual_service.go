...
/*
EdgeGatewayLoadBalancerVirtualServiceApiService Delete the specified Virtual Service.
...
func (a *EdgeGatewayLoadBalancerVirtualServiceApiService) DeleteVirtualService(ctx context.Context, virtualServiceId string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/loadBalancer/virtualServices/{virtualServiceId}"
	localVarPath = strings.Replace(localVarPath, "{"+"virtualServiceId"+"}", fmt.Sprintf("%v", virtualServiceId), -1)
...
/*
EdgeGatewayLoadBalancerVirtualServiceApiService Get Virtual Service.
...
/*
EdgeGatewayLoadBalancerVirtualServiceApiService Update specified Virtual Service.
