...
/*
OrgVdcNetworkApiService Deletes a specific Org vDC network.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param vdcNetworkId
 * @param optional nil or *OrgVdcNetworkApiDeleteNetworkOpts - Optional Parameters:
...
func (a *OrgVdcNetworkApiService) DeleteNetwork(ctx context.Context, vdcNetworkId string, localVarOptionals *OrgVdcNetworkApiDeleteNetworkOpts) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/orgVdcNetworks/{vdcNetworkId}"
	localVarPath = strings.Replace(localVarPath, "{"+"vdcNetworkId"+"}", fmt.Sprintf("%v", vdcNetworkId), -1)
...
/*
OrgVdcNetworkApiService Retrieve the list of IP addresses allocated to the network.
 ...
 * @param vdcNetworkId
 * @param optional nil or *OrgVdcNetworkApiGetAllocatedIpAddressesOpts - Optional Parameters:
...
func (a *OrgVdcNetworkApiService) GetAllocatedIpAddresses(ctx context.Context, page int32, pageSize int32, vdcNetworkId string, localVarOptionals *OrgVdcNetworkApiGetAllocatedIpAddressesOpts) (AllocatedIpAddresses, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/orgVdcNetworks/{vdcNetworkId}/allocatedIpAddresses"
	localVarPath = strings.Replace(localVarPath, "{"+"vdcNetworkId"+"}", fmt.Sprintf("%v", vdcNetworkId), -1)
...
/*
OrgVdcNetworkApiService Retrieve the list of secondary IP addresses allocated to the network, if the network is a dual stack network.
 ...
 * @param pageSize Results per page to fetch.
 * @param vdcNetworkId
 * @param optional nil or *OrgVdcNetworkApiGetSecondaryAllocatedIpAddressesOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
func (a *OrgVdcNetworkApiService) GetSecondaryAllocatedIpAddresses(ctx context.Context, page int32, pageSize int32, vdcNetworkId string, localVarOptionals *OrgVdcNetworkApiGetSecondaryAllocatedIpAddressesOpts) (AllocatedIpAddresses, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/orgVdcNetworks/{vdcNetworkId}/secondaryAllocatedIpAddresses"
	localVarPath = strings.Replace(localVarPath, "{"+"vdcNetworkId"+"}", fmt.Sprintf("%v", vdcNetworkId), -1)
...
/*
OrgVdcNetworkApiService Reset a specific isolated Org vDC network.
...
func (a *OrgVdcNetworkApiService) ResetNetwork(ctx context.Context, vdcNetworkId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/orgVdcNetworks/{vdcNetworkId}/reset"
	localVarPath = strings.Replace(localVarPath, "{"+"vdcNetworkId"+"}", fmt.Sprintf("%v", vdcNetworkId), -1)
...
/*
OrgVdcNetworkApiService Sync/repair a specific Org vDC network.
...
func (a *OrgVdcNetworkApiService) SyncOrgVdcNetwork(ctx context.Context, vdcNetworkId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/orgVdcNetworks/{vdcNetworkId}/sync"
	localVarPath = strings.Replace(localVarPath, "{"+"vdcNetworkId"+"}", fmt.Sprintf("%v", vdcNetworkId), -1)
...
/*
OrgVdcNetworkApiService Synchronize syslog server settings for a Org vDC network.
...
func (a *OrgVdcNetworkApiService) SyncSyslogSettingsOfNetwork(ctx context.Context, vdcNetworkId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/orgVdcNetworks/{vdcNetworkId}/syncSyslog"
	localVarPath = strings.Replace(localVarPath, "{"+"vdcNetworkId"+"}", fmt.Sprintf("%v", vdcNetworkId), -1)
