...
/*
CertificateLibraryApiService Add an item to the certificate library
...
func (a *CertificateLibraryApiService) AddCertificateLibraryItem(ctx context.Context, newCertificateLibraryItem CertificateLibraryItem) (CertificateLibraryItem, *http.Response, error) {
	var (
		...
		localVarReturnValue CertificateLibraryItem
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/ssl/certificateLibrary"
	...
	// body params
	localVarPostBody = &newCertificateLibraryItem
	if ctx != nil {
...
/*
CertificateLibraryApiService Adds the specified consumer reference to a library item.
...
func (a *CertificateLibraryApiService) AddConsumerRefToCertLibraryItem(ctx context.Context, consumerReference EntityReference, certLibraryItemId string) (EntityReference, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/ssl/certificateLibrary/{certLibraryItemId}/consumers"
	localVarPath = strings.Replace(localVarPath, "{"+"certLibraryItemId"+"}", fmt.Sprintf("%v", certLibraryItemId), -1)
	...
	// body params
	localVarPostBody = &consumerReference
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
/*
CertificateLibraryApiService Remove certificate library item.
...
func (a *CertificateLibraryApiService) DeleteCertificateLibraryItem(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/ssl/certificateLibrary/{id}"
...
/*
CertificateLibraryApiService Get the specified certificate library item
...
/*
CertificateLibraryApiService Gets a paged list of consumers (as references) of a particular certificate library item
 ...
 * @param certLibraryItemId
 * @param optional nil or *CertificateLibraryApiQueryCertLibraryItemConsumerRefsOpts - Optional Parameters:
...
/*
CertificateLibraryApiService Get the certificate libray items
Get a list of the certificate library items
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *CertificateLibraryApiQueryCertificateLibraryOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
func (a *CertificateLibraryApiService) QueryCertificateLibrary(ctx context.Context, page int32, pageSize int32,
	...
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CertificateLibraryItems
	)
...
/*
CertificateLibraryApiService Replaces the existing consumer refs with the used by references supplied.
...
/*
CertificateLibraryApiService Update the specified certificate library item.
...
func (a *CertificateLibraryApiService) UpdateCertificateLibraryItem(ctx context.Context, modifiedCertificatLibraryItem CertificateLibraryItem, id string) (CertificateLibraryItem, *http.Response, error) {
	...
	// body params
	localVarPostBody = &modifiedCertificatLibraryItem
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
