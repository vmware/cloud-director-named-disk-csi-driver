...
|:-----------:|:-----------:|:-------------------------:|:--------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------:|
|   1.5.0g    |    4.1.z    |           36.0+           |                                          10.3.3.4+                                           |                                                                                                                                                                                 <ul><li>Bump gopkg.in/yaml.v3 version (#221)</li><li>Changes to testing framework (multiple PR's)</li></ul>                                                                                                                                                                                  | <ul><li>1.27</li><li>1.26</li><li>1.25</li><li>1.24</li><li>1.23</li><li>1.22</li></ul> |  [CSI `main` docs](https://github.com/vmware/cloud-director-named-disk-csi-driver/tree/main)  |
...
```
2. Apply the CSI 1.5 Controller CRS:
```shell
kubectl apply -f https://github.com/vmware/cloud-director-named-disk-csi-driver/blob/1.5.z/manifests/csi-controller-crs.yaml
```
**NOTE:**

1. These steps ensure a successful upgrade of CSI to the latest version (v1.5.0) and guarantee that the new CSI Deployment is properly installed within the Kubernetes environment.
