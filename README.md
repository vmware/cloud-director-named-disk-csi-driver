...
| :---------: | :---------: | :-----------------------: | :--------------------------------: | :----: | :----------------------- | :--: |
| 1.3.2 | 4.0.0 | 36.0+ | 10.3.1+ <br/>(10.3.1 needs hot-patch to prevent VCD cell crashes in multi-cell environments) |<ul><li>Added XFS filesystem support (Fixes[#122](https://github.com/vmware/cloud-director-named-disk-csi-driver/issues/122)) </li><li>Updated CSI container registry references to use 'registry.k8s.io' (refer to the [announcement](https://kubernetes.io/blog/2023/02/06/k8s-gcr-io-freeze-announcement) for the detailed information) </li></ul> |<ul><li>1.22</li><li>1.21</li><li>1.20</li><li>1.19</li></ul>|[CSI 1.3.z docs](https://github.com/vmware/cloud-director-named-disk-csi-driver/tree/1.3.z)|
